...
- **Methodology discussion** — you disagree with a design decision, think a phase should work differently, believe the analysis methodology has a gap, or want to propose a structural change. We treat methodology disagreements the same way we treat bugs — they're issues to be investigated, discussed, and resolved. A methodology that can't withstand scrutiny shouldn't be trusted.
- **Feedback** — any general thoughts, suggestions, criticism, or observations about your experience

If you're unsure whether something is worth reporting — it is. Even "this felt weird" or "I didn't understand this part" is valuable. And if you think the methodology itself is wrong — that's especially worth raising.

## How to File an Issue

1. Go to: https://github.com/CloudSecurityAlliance/csa-plugins-official/issues
2. Click **"New Issue"**
3. In the **title**, include the plugin name (e.g., `[cwe-analysis] Brief description of the issue`)
